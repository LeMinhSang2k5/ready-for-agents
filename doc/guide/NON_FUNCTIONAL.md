...
|----|---------|--------------|
| NFR-1-1 | `doctor` hoàn thành trong vài giây trên project thường | Chỉ ~15 thao tác sync FS; không đọc `node_modules` |
...
| ID | Yêu cầu |
|----|---------|
| NFR-4-1 | Exit code nhất quán (0 success, 1 validation/critical fail) |
